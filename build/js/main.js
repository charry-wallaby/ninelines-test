...
function closeMenu() {
  return new Promise(function (resolve) {
    ...
    setTimeout(function () {
      if (_helpers__WEBPACK_IMPORTED_MODULE_0__["default"].winWidth <= 1024) {
...
function headerScroll() {
  if (_helpers__WEBPACK_IMPORTED_MODULE_0__["default"].$window.scrollTop() > 10) {
    _helpers__WEBPACK_IMPORTED_MODULE_0__["default"].$body.addClass('is-scrolled');
  } else {
    _helpers__WEBPACK_IMPORTED_MODULE_0__["default"].$body.removeClass('is-scrolled');
  }
}
function initScroll() {
  headerScroll();
  _helpers__WEBPACK_IMPORTED_MODULE_0__["default"].$window.on('scroll', function () {
    headerScroll();
  });
}
  ...
  link.addEventListener('click', function (event) {
    ...
    switch (event.currentTarget.dataset.social) {
      case 'facebook':
        ...
        break;
      case 'vk':
        ninelines_sharing__WEBPACK_IMPORTED_MODULE_0___default.a.vk(url);
        break;
      case 'telegram':
...
/* harmony import */ var _modules_scrollAnimation__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! ./modules/scrollAnimation */ "./src/js/modules/scrollAnimation.js");
...
_components_header__WEBPACK_IMPORTED_MODULE_7__["default"].initScroll();
_modules_lazyLoading__WEBPACK_IMPORTED_MODULE_8__["default"].init();
_modules_scrollAnimation__WEBPACK_IMPORTED_MODULE_11__["default"].init();
...
var preloaderImg = document.querySelector('.preloader__image');
var orientScreen = window.matchMedia('(orientation: portrait)');
var arrayImages = ['images/logo.png', 'images/boy.png', 'images/hands.png'];
var imageAnimate = function imageAnimate(el, posX, posY) {
  tl.to(el, {
    x: posX,
    y: posY,
    duration: 6
...
ninelines_preloader__WEBPACK_IMPORTED_MODULE_0___default.a.init(arrayImages).then(function () {
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var locomotive_scroll__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! locomotive-scroll */ "./node_modules/locomotive-scroll/dist/locomotive-scroll.mjs");
/* harmony import */ var gsap__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! gsap */ "./node_modules/gsap/index.js");


var init = function init() {
  var locomotiveScroll = new locomotive_scroll__WEBPACK_IMPORTED_MODULE_0__["default"]();
  var tl = gsap__WEBPACK_IMPORTED_MODULE_1__["default"].timeline({
    paused: true
  });
  var $footerImg = $('.footer__image');
  var $btnTop = $('#btnTop');
  var $btnTopProgress = $('#btnTopProgress');
  var percentHeight = +($(window).innerHeight() / $('html').height() * 100).toFixed(0);
  tl.to($footerImg, {
    scale: 0,
    opacity: 0,
    duration: 10,
  ...
  $(window).on('progressEvent', function (e) {
    var progress = e.detail.progress;
    var progressFix = +(progress * 100).toFixed(0) + percentHeight;
  ...
  $(window).on('scrollScale', function (e) {
    var progress = e.detail.progress;
...
var init = function init() {
  _helpers__WEBPACK_IMPORTED_MODULE_1__["default"].$document.on('click.anchor', '.js-to-anchor', function (e) {
    ...
    var id = thisItem.attr('href');
    var speed = thisItem.data('speed') || 500;
    var headerHeight = _helpers__WEBPACK_IMPORTED_MODULE_1__["default"].winWidth <= 1024 ? -_helpers__WEBPACK_IMPORTED_MODULE_1__["default"].$header.outerHeight(true) + 50 : -_helpers__WEBPACK_IMPORTED_MODULE_1__["default"].$header.outerHeight(true) + 30;
    var offset = _helpers__WEBPACK_IMPORTED_MODULE_1__["default"].$header.css('position') === 'fixed' || _helpers__WEBPACK_IMPORTED_MODULE_1__["default"].$header.css('position') === 'absolute' ? headerHeight : 0;
